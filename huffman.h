...
public:
	node_val_t(void) :
		std::pair<node_t, weight_t>(0, 0)
	{}
	node_val_t(node_t data, weight_t weight = 0) :
		std::pair<node_t, weight_t>(data, weight)
	{}
};
template<class node_t>
...
{
public:
	node_val_list_t(void) :
		std::vector<node_val_t<node_t>>()
	{}
	node_val_list_t(node_val_t<node_t>child) :
		std::vector<node_val_t<node_t>>(child)
	{}
